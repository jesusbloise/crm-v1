...
//   id TEXT PRIMARY KEY,
//   type TEXT NOT NULL,         -- created|updated|deleted|stage_changed|note_added|task_added|...
//   entity TEXT NOT NULL,       -- contact|account|deal|lead|note|activity
//   entity_id TEXT NOT NULL,
//   description TEXT NOT NULL,  -- corto y legible
//   actor TEXT,                 -- opcional: usuario que hizo la acción (si lo manejan)
//   meta TEXT,                  -- JSON string opcional (detalles)
//   created_at INTEGER NOT NULL
// );
